          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <div className="w-full md:w-1/2">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] shadow-2xl">
                <img src={tattooMaster.image} alt={tattooMaster.name} className="absolute inset-0 w-full h-full object-cover" />
              </div>
            </div>
        ...
        <div className="container mx-auto max-w-6xl grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[200px] md:auto-rows-[280px] grid-flow-row-dense">
          {tattooImages.map((img, index) => {
            ...
            return (
              ...
              >
                <img src={img.src} alt="Tattoo" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
