  ...
  return (
    <section id="opinie" className="bg-foxy-bg py-16 md:py-24 px-4 overflow-hidden border-t border-white/5">
      <div className="container mx-auto max-w-4xl">
        ...
        {/* Заголовок: колір виправлено на foxy-text */}
        ...
        >
          ...
          <div className="min-h-[420px] md:min-h-[500px] flex items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Фото */}
                <div className="w-full max-w-[320px] md:max-w-[450px] aspect-[4/3] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden shadow-2xl border border-white/10 relative z-10 bg-[#151515]">
                  <img src={reviewsData[index].image} alt="Stylizacja" className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" />
                </div>

                {/* Bubble */}
                <div className="relative mt-[-15px] md:mt-[-20px] pt-[15px] md:pt-[20px] w-full max-w-[340px] md:max-w-[500px] z-20">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-b-[16px] border-b-[#e6e0d2]" />
                  <div className="bg-[#e6e0d2] p-6 md:p-8 rounded-[1.8rem] md:rounded-[2.5rem] shadow-2xl border border-black/5">
                    <p className="text-[#2a2a2a] font-lato text-sm md:text-lg italic leading-relaxed text-center mb-4 md:mb-6">
                      "{reviewsData[index].text}"
                    </p>
                    <div className="text-center">
                      <p className="text-foxy-accent font-black uppercase tracking-[0.2em] text-[9px] md:text-xs">
